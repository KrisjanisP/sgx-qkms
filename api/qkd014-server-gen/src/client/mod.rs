    ...
    B::Error: Into<Box<dyn Error + Send + Sync>>,
{
    ...
    async fn get_key(
        ...
        param_key_request: Option<models::KeyRequest>,
        context: &C) -> Result<GetKeyResponse, ApiError>
    {
        ...
        let mut uri = format!(
            ...
            self.base_path
            ,slave_sae_id=utf8_percent_encode(&param_slave_sae_id.to_string(), ID_ENCODE_SET)
        );
        ...
        // Consumes basic body
        // Body parameter
        if let Some(param_key_request) = param_key_request {
        let body = serde_json::to_string(&param_key_request).expect("impossible to fail to serialize");
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<models::KeyContainer>(body)
                    .map_err(|e| ApiError(format!("Response body did not match the schema: {e}")))?;


                Ok(GetKeyResponse::KeysRetrievedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetKeyResponse::BadRequestFormat
                    (body)
                )
            }
            401 => {
        ...
        context: &C) -> Result<GetKeySimpleResponse, ApiError>
    {
        ...
        let query_string = {
            let mut query_string = form_urlencoded::Serializer::new("".to_owned());
            if let Some(param_number) = param_number {
                query_string.append_pair("number",
                    &param_number.to_string());
            }
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetKeySimpleResponse::KeysRetrievedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetKeySimpleResponse::BadRequestFormat
                    (body)
                )
            }
            401 => {
    ...
    async fn get_key_with_ids(
        &self,
        param_master_sae_id: String,
        param_key_ids: models::KeyIds,
        context: &C) -> Result<GetKeyWithIdsResponse, ApiError>
    {
        ...
        let mut uri = format!(
            ...
            self.base_path
            ,master_sae_id=utf8_percent_encode(&param_master_sae_id.to_string(), ID_ENCODE_SET)
        );
        ...
        // Consumes basic body
        // Body parameter
        let body = serde_json::to_string(&param_key_ids).expect("impossible to fail to serialize");
        *request.body_mut() = body_from_string(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetKeyWithIdsResponse::KeysRetrievedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetKeyWithIdsResponse::BadRequestFormat
                    (body)
                )
            }
            401 => {
        ...
        context: &C) -> Result<GetKeyWithIdsSimpleResponse, ApiError>
    {
        ...
        let query_string = {
            let mut query_string = form_urlencoded::Serializer::new("".to_owned());
                query_string.append_pair("key_ID",
                    &param_key_id.to_string());
            query_string.finish()
        };
        if !query_string.is_empty() {
            uri += "?";
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetKeyWithIdsSimpleResponse::KeysRetrievedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetKeyWithIdsSimpleResponse::BadRequestFormat
                    (body)
                )
            }
            401 => {
        ...
        context: &C) -> Result<GetStatusResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetStatusResponse::StatusRetrievedSuccessfully
                    (body)
                )
            }
            400 => {
                ...
                Ok(GetStatusResponse::BadRequestFormat
                    (body)
                )
            }
            401 => {
            ...
            503 => {
                ...
                Ok(GetStatusResponse::ErrorOnServerSide
                    (body)
                )
            }
            code => {
